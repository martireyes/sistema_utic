                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Eliminar Proveedores</h3>
                                <div class="box-tools">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="text" class="form-control" name="vprv_ruc" value="<?php echo $resultado[0]['prv_ruc'];?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="hidden" name="accion" value="3">
                                            <input type="hidden" name="vprv_cod" value="<?php echo $resultado[0]['prv_cod'];?>">
                                            <input type="text" class="form-control" name="vprv_razonsocial" value="<?php echo $resultado[0]['prv_razonsocial'];?>" disabled>
                                        </div>
                                    </div>
                                </div>
