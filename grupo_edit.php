                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="grupo_index.php" class="btn btn-primary pull-right btn-sm">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            ...
                                            <input type="text" class="form-control" name="vgru_nombre" value="<?php echo $resultado[0]['gru_nombre']?>" required autofocus="">
                                        </div>
                                    </div>
                                </div>
