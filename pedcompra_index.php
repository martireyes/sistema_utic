                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        ...
                        <div class="alert alert-danger" role="alert" id="mensaje">
                            ...
                            <div class="box-header">
                                ...
                                <div class="box-tools">
                                    <a href="pedcompra_add.php" class="btn btn-primary pull-right btn-sm">
                            ...
                            <div class="box-body no-padding">
                                <div class="row">
                                    <div class="col-md-12 col-xs-12 col-lg-12">
                                        <?php
                                        $proveedores = consultas::get_datos("select * from ped_compra order by ped_cod desc");
                                        ...
                                        <div class="table-responsive">
                                            <table class="table col-lg-12 col-md-12 col-xs-12 table-bordered table-striped table-condensed">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td data-title="RUC"><?php echo $prov['prv_ruc'];?></td>
                                                        <td data-title="Razón Social"><?php echo $prov['prv_razonsocial'];?></td>
