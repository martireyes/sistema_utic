<!--Inicio::Encabezado de la app-->
                ...
                <!--Fin::Encabezado de la app-->
                <!--Inicio::Contenido de la app-->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <!--Fin::Pequeño Widget 1-->
                            </div>
                            <!--Fin::Columna 1-->
                            <!--Inicio::Columna 2-->
                            <div class="col-lg-3 col-6">
                                <!--Inicio::Pequeño Widget 2-->
                                ...
                                <!--Fin::Pequeño Widget 2-->
                            </div>
                            <!--Fin::Columna 2-->
                            <!--Inicio::Columna 3-->
                            <div class="col-lg-3 col-6">
                            <!--Inicio::Pequeño Widget 3-->
                            ...
                            <!--Fin::Pequeño Widget 3-->
                            </div>
                            <!--Fin::Columna 3-->
                            <!--Inicio::Columna 4-->
                            <div class="col-lg-3 col-6">
                                <!--Inicio::Pequeño Widget 4-->
                            ...
                            <div class="col-lg-7 connectedSortable">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h3 class="card-title">Valor de ventas</h3>
                                    </div>
